...
ThinkPHP通用后台使用协议
本通用后台为 <b><a href="http://weibo.com/ybyq2010" target="_blank">@_IUAN_</a></b> 为QQ群：232045732 群友学习参考用，其中没有做过多数据过滤完全考虑和界面兼容处理，如果你将本通用后台使用于你自己的系统中，请自行处理（不过不会有太多的问题）。
...
版权所有(c)2012-2013，<a href="http://www.w3cdream.com" target="_blank" >http://www.w3cdream.com</a> 保留所有权力。</a></pre>
                </div>
