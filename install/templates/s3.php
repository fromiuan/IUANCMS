                    ...
                    <div class="server">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="dbname" id="dbname" value="iuancms" class="input"></td>
                                <td><div id="J_install_tip_dbname"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">数据库表前缀：</td>
                                <td><input type="text" name="dbprefix" id="dbprefix" value="hd_" class="input"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sitename" value="IUANCMS内容管理系统后台" class="input"></td>
                            ...
                            <tr>
                                <td class="tar">关键词：</td>
                                <td><input type="text" name="sitekeywords" value="IUANCMS内容管理系统" class="input" autoComplete="off"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><div id="J_install_tip_manager_email">用户帐号</div></td>
                            </tr>
                            <tr>
                                <td class="tar">密码：</td>
                            ...
                            <tr>
                                ...
                                <td><input name="testdata" type="checkbox" value="1" alt="测试数据需要安装在根目录下才可以完整体验-__,-!" title="测试数据需要安装在根目录下才可以完整体验-__,-!"/><span class="gray">默认测试数据，了解IUANCMS！</span></td>
