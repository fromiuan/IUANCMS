...
<body>
	<form action="<?php echo U(GROUP_NAME .'/Rbac/addNodeHanlde');?>" method="post">
		<table class="table">
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="name" value="<?php echo ($id["name"]); ?>">
				</td>
			</tr>
			<tr>
				<td align="right"><?php echo ($type); ?>描述</td>
				<td>
					<input type="text" name="title" value="<?php echo ($id["title"]); ?>">
				</td>
			</tr>
			<tr>
